...
/**
 * Created by com.andres_k on 16/03/2015.
 */
public enum EInput {
    // TYPE
    NOTHING("NOTHING"),
    ...
    ATTACK_C_P1(1, ATTACK_C.value + "_P1"), ATTACK_D_P1(1, ATTACK_D.value + "_P1"),
    ...
    ATTACK_C_P2(2, ATTACK_C.value + "_P2"), ATTACK_D_P2(2, ATTACK_D.value + "_P2"),
