...
public class InterfaceElementData extends DataManager {
    ...
    public void initControlsContent() throws NoSuchMethodException, SlickException, JSONException {
        ...
        playerControls.createList(MyElementFactory.createText("Player 1", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 16, 0, 0), 0, 20);
        playerControls.createList(MyElementFactory.createText("Player 2", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 16, 0, 0), 0, 20);
