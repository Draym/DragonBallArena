package com.andres_k.custom.component.gameComponent.gameObject.objects.characters.players;
...
import com.andres_k.custom.component.gameComponent.gameObject.objects.characters.Fighter;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.KiEntity;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.KiInvulnerableAttack;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.KiProjectiles;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.linked.FinalFlash;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.vulnerable.BigBang;
...
public class Vegeta extends Fighter {
    public Vegeta(AnimatorController animatorController, String id, float x, float y) {
        super(animatorController, EGameObject.VEGETA, id, 0, x, y, 3300, 1, 270, 220, 15);
        try {
