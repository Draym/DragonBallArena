...
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.linked.Kameha;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.linked.MegaKameha;
import com.andres_k.custom.component.gameComponent.gameObject.objects.entities.ki.vulnerable.Genkidama;
...
public class Goku extends Fighter {
    ...
    public Goku(AnimatorController animatorController, String id, float x, float y) {
        super(animatorController, EGameObject.GOKU, id, 0, x, y, 3000, 1, 270, 220, 15);
        try {
