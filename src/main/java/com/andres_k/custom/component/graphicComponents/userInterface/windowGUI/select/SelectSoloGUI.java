...
public class SelectSoloGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        //packSelect
        ComplexRelayElement packSelect = MyElementFactory.createPackSelectPlayer(ELocation.SELECT_SOLO_GUI_SelectPackPlayer);
        ...
        buttonList.addItem(MyElementFactory.createButtonTitleText(" Resume ", ColorTools.get(ColorTools.Colors.GUI_GREEN), EFont.MODERN, 25, EGuiElement.BUTTON_RESUME, MyElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI, ELocation.SELECT_SOLO_GUI_Options, ETaskType.ON_KILL), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText(" Combo ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_COMBO, MyElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI_Options, ELocation.SELECT_SOLO_GUI_Combos, ETaskType.ON_CREATE), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText("Settings", ColorTools.get(ColorTools.Colors.GUI_GREY), EFont.MODERN, 25, EGuiElement.BUTTON_SETTING, MyElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI_Options, ELocation.SELECT_SOLO_GUI_Settings, ETaskType.ON_CREATE), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText(" Return ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, MyElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI, ELocation.SELECT_SOLO_CONTROLLER, EnumWindow.HOME), MyElementFactory.createImageFocusTasks()));
        ...
        settings.addItem(new Button(new ImageElement(new ColorCircle(new Circle(530, 15, 0)), ResourceManager.get().getGuiAnimator(EGuiElement.BUTTON_CLOSE), true), MyElementFactory.createBasicButtonTasks(ELocation.UNKNOWN, ELocation.SELECT_SOLO_GUI_Settings, ETaskType.ON_KILL, ESound.NOTHING, ESound.UNVALIDATE)));
        settings.addItem(GuiElementsManager.get().getElement(ELocation.GUI_ELEMENT_Volumes.getId()));
        settings.addItem(MyElementFactory.createButtonTitleText("Controls", ColorTools.get(ColorTools.Colors.GUI_GREY), EFont.MODERN, 25, EGuiElement.BUTTON_CONTROLS, 270, 390, MyElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI_Settings, ELocation.SELECT_SOLO_GUI_Controls, ETaskType.ON_CREATE), MyElementFactory.createImageFocusTasks()));
        ...
        settingModal.addTasks(MyElementFactory.createBasicModalTasks(ELocation.SELECT_SOLO_GUI_Settings, ELocation.SELECT_SOLO_GUI_Options));
        ...
        controls.addItem(new Button(new ImageElement(new ColorCircle(new Circle(530, 15, 0)), ResourceManager.get().getGuiAnimator(EGuiElement.BUTTON_CLOSE), true), MyElementFactory.createBasicButtonTasks(ELocation.UNKNOWN, ELocation.SELECT_SOLO_GUI_Controls, ETaskType.ON_KILL, ESound.NOTHING, ESound.UNVALIDATE)));
        ...
        controlModal.addTasks(MyElementFactory.createBasicModalTasks(ELocation.SELECT_SOLO_GUI_Controls, ELocation.SELECT_SOLO_GUI_Settings));
