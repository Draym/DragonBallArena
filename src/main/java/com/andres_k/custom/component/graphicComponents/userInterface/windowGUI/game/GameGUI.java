...
import com.andres_k.gameToolsLib.components.gameComponent.commands.comboComponent.combo.ComboAvailableList;
...
public class GameGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        ...
        buttonList.addItem(MyElementFactory.createButtonTitleText(" Resume ", ColorTools.get(ColorTools.Colors.GUI_GREEN), EFont.MODERN, 25, EGuiElement.BUTTON_RESUME, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI, ELocation.GAME_GUI_Options, ETaskType.ON_KILL), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText(" Combo ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_COMBO, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI_Options, ELocation.GAME_GUI_Combos, ETaskType.ON_CREATE), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText("Settings", ColorTools.get(ColorTools.Colors.GUI_GREY), EFont.MODERN, 25, EGuiElement.BUTTON_SETTING, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI_Options, ELocation.GAME_GUI_Settings, ETaskType.ON_CREATE), MyElementFactory.createImageFocusTasks()));
        buttonList.addItem(MyElementFactory.createButtonTitleText("  Exit  ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI, ELocation.GAME_CONTROLLER, EnumWindow.HOME), MyElementFactory.createImageFocusTasks()));
        ...
        settingModal.addTasks(MyElementFactory.createBasicModalTasks(ELocation.GAME_GUI_Settings, ELocation.GAME_GUI_Options));
        ...
        controls.addItem(new Button(new ImageElement(new ColorCircle(new Circle(530, 15, 0)), ResourceManager.get().getGuiAnimator(EGuiElement.BUTTON_CLOSE), true), MyElementFactory.createBasicButtonTasks(ELocation.UNKNOWN, ELocation.GAME_GUI_Controls, ETaskType.ON_KILL, ESound.NOTHING, ESound.UNVALIDATE)));
        ...
        controlModal.addTasks(MyElementFactory.createBasicModalTasks(ELocation.GAME_GUI_Controls, ELocation.GAME_GUI_Settings));
        ...
        combos.addItem(new Button(new ImageElement(new ColorCircle(new Circle(530, 15, 0)), ResourceManager.get().getGuiAnimator(EGuiElement.BUTTON_CLOSE), true), MyElementFactory.createBasicButtonTasks(ELocation.UNKNOWN, ELocation.GAME_GUI_Combos, ETaskType.ON_KILL, ESound.NOTHING, ESound.UNVALIDATE)));
        ...
        comboModal.addTasks(MyElementFactory.createBasicModalTasks(ELocation.GAME_GUI_Combos, ELocation.GAME_GUI_Options));
        ...
        panelQuit.addItem(MyElementFactory.createButtonTitleText("Replay !", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_PLAY_VERSUS, 160, 320, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI, ELocation.GAME_CONTROLLER, ETaskType.LAUNCH), MyElementFactory.createImageFocusTasks()));
        panelQuit.addItem(MyElementFactory.createButtonTitleText("Home", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, 160, 390, MyElementFactory.createBasicButtonTasks(ELocation.GAME_GUI, ELocation.GAME_CONTROLLER, EnumWindow.HOME), MyElementFactory.createImageFocusTasks()));
    ...
    public void initOnEnter() throws SlickException {
        if (GameConfig.mode != EMode.ONLINE) {
            ...
            for (EGameObject player : GameConfig.typePlayer) {
                combos.createList(MyElementFactory.createText(player.getValue(), ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 16, 0, 0), 0, 20);
                ...
                for (Pair<String, String> item : combosList) {
                    ...
                    TextElement content = MyElementFactory.createText(item.getV2(), ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 16, 200, 0);
                    combos.addItem(player.getValue(), new ElementWithTitle(new ColorRect(new Rectangle(0, 0, 0, 0)), title, content, true));
                }
            }
        }
        ...
        panelQuitDetails.addItem(MyElementFactory.createText("End of the Game !", ColorTools.get(ColorTools.Colors.GUI_YELLOW_BLAND), EFont.MODERN, 30, 90, 0));
