...
//            animatorController.addEffect(EAnimation.IDLE, 0, 0, EffectFactory.zoomIt(10, 0.1f, 1.3f));
        }
        return animatorController;
    }
    ...
    public AnimatorController getGuiCardsAnimator(ESprites index) throws SlickException {
        ...
        if (index == ESprites.CARDS_ALL) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/gokuCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 7, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/gohanCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 2, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/vegetaCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 1, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/picoloCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 3, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/kameSenninCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 6, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/cellCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 5, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/buuCard.jpg"));
            animatorController.addAnimation(EAnimation.IDLE, 4, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_card + "/frieezaCard.jpg"));
        }
        return animatorController;
    }
    ...
    public AnimatorController getGuiIconAnimator(ESprites index) throws SlickException {
        ...
        if (index == ESprites.ICON_GOKU) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/gokuIcon.png"));
        } else if (index == ESprites.ICON_GOHAN) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/gohanIcon.png"));
        } else if (index == ESprites.ICON_VEGETA) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/vegetaIcon.png"));
        } else if (index == ESprites.ICON_PICOLO) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/picoloIcon.png"));
        } else if (index == ESprites.ICON_KAME_SENNIN) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/kameSenninIcon.png"));
        } else if (index == ESprites.ICON_CELL) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/cellIcon.png"));
        } else if (index == ESprites.ICON_BUU) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/buuIcon.png"));
        } else if (index == ESprites.ICON_FRIEEZA) {
            animatorController.addAnimation(EAnimation.IDLE, 0, AnimationFactory.createStaticUniqueFrame(ConfigPath.image_icon + "/frieezaIcon.png"));
        }
        return animatorController;
    }
}
