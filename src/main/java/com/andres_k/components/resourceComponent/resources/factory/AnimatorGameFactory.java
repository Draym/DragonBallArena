...
public class AnimatorGameFactory extends AnimatorFactory {
    ...
    public AnimatorController getGokuAnimator() throws SlickException, JSONException, NoSuchMethodException {
        ...
        //TOUCHED_FALL
        animatorController.addAnimation(EAnimation.TOUCHED_FALL, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.image_game + id + "/gokuTouchedFall.png", 247, 247), EAnimation.TOUCHED_FALL.isLoop(), 0, 1, 0, 1, new int[]{1000}));
