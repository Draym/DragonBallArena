...
public class AnimatorGameFactory extends AnimatorFactory {
    ...
    public AnimatorController getGokuAnimator() throws SlickException, JSONException, NoSuchMethodException {
        ...
        animatorController.addRepercussion(EAnimation.HAND_FLY_PROPELS, 0, new AnimationRepercussionItem(EAnimation.TOUCHED_FLIP, 70, new Pair<>(0f, 0f)));
        ...
        animatorController.addRepercussion(EAnimation.JUMP_KICK, 0, new AnimationRepercussionItem(EAnimation.TOUCHED_SIMPLE, 30, new Pair<>(GameConfig.speedTravel * 2, 0f)));
        ...
        animatorController.addRepercussion(EAnimation.JUMP_KICK, 1, new AnimationRepercussionItem(EAnimation.TOUCHED_SIMPLE, 30, new Pair<>(GameConfig.speedTravel * 2, 0f)));
        ...
        animatorController.addRepercussion(EAnimation.JUMP_KICK, 2, new AnimationRepercussionItem(EAnimation.TOUCHED_SIMPLE, 30, new Pair<>(GameConfig.speedTravel * 2, 0f)));
        // SPIRAL_KICK
        ...
        animatorController.addRepercussion(EAnimation.SPIRAL_KICK, 0, new AnimationRepercussionItem(EAnimation.TOUCHED_MEDIUM, 40, new Pair<>(GameConfig.speedTravel * 3, 0f), true));
        ...
        animatorController.addRepercussion(EAnimation.SPIRAL_KICK, 1, new AnimationRepercussionItem(EAnimation.TOUCHED_MEDIUM, 40, new Pair<>(GameConfig.speedTravel * 3, 0f), true));
        ...
        animatorController.addRepercussion(EAnimation.SPIRAL_KICK, 2, new AnimationRepercussionItem(EAnimation.TOUCHED_MEDIUM, 40, new Pair<>(GameConfig.speedTravel * 3, 0f), true));
        // KICK_PROPELS
