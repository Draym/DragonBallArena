...
public class SelectMultiGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        ...
        buttonList.addItem(ElementFactory.createButtonTitleText(" Return ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, ElementFactory.createBasicButtonTasks(ELocation.SELECT_MULTI_GUI, ELocation.SELECT_MULTI_CONTROLLER, EnumWindow.HOME), ElementFactory.createImageFocusTasks()));
