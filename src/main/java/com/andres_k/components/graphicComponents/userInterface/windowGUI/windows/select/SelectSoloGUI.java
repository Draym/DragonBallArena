...
public class SelectSoloGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        ...
        buttonList.addItem(ElementFactory.createButtonTitleText(" Return ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, ElementFactory.createBasicButtonTasks(ELocation.SELECT_SOLO_GUI, ELocation.SELECT_SOLO_CONTROLLER, EnumWindow.HOME), ElementFactory.createImageFocusTasks()));
