...
public class HomeGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        ...
        buttonList.addItem(ElementFactory.createButtonTitleText("Battle  ", ColorTools.get(ColorTools.Colors.GUI_ORANGE), EFont.MODERN, 25, EGuiElement.BUTTON_PLAY_MULTI, ElementFactory.createBasicButtonTasks(ELocation.HOME_GUI, ELocation.HOME_CONTROLLER, EnumWindow.EXIT /*EnumWindow.SELECT_MULTI*/), ElementFactory.createImageFocusTasks()));
