 ...
 */
public class SelectVersusGUI2 extends UserInterface {
    public SelectVersusGUI2() {
    ...
    public void init() throws SlickException {
        ...
        buttonList.addItem(ElementFactory.createButtonTitleText("  Exit  ", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_EXIT, ElementFactory.createBasicButtonTasks(ELocation.SELECT_VERSUS_GUI, ELocation.SELECT_VERSUS_CONTROLLER, EnumWindow.HOME), ElementFactory.createImageFocusTasks()));
