...
import com.andres_k.components.graphicComponents.userInterface.windowGUI.windows.select.SelectMultiGUI2;
...
public class WindowSelectMulti extends WindowBasedGame {
    public WindowSelectMulti(LocalTaskManager windowsTask) throws JSONException, SlickException {
        super(EnumWindow.SELECT_MULTI.getId(), new SelectMultiController(EnumWindow.SELECT_MULTI.getId()), new SelectMultiGUI2());
