...
public class AnimatorGameFactory extends AnimatorFactory {
    ...
    public AnimatorController getPlayerAnimator(EnumSprites index) throws SlickException, JSONException, NoSuchMethodException {
        ...
        if (index == EnumSprites.GOKU) {
            ...
            state = "/basic";
            //IDLE
            animatorController.addAnimation(EnumAnimation.IDLE, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuIdle.png", 247, 247), EnumAnimation.IDLE.isLoop(), 0, 4, 0, 1, new int[]{200, 200, 200, 200}));
            ...
            // FALL
            animatorController.addAnimation(EnumAnimation.FALL, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuFall.png", 247, 247), EnumAnimation.FALL.isLoop(), 0, 1, 0, 1, new int[]{200}));
            ...
            // RUN
            animatorController.addAnimation(EnumAnimation.RUN, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuRun.png", 247, 247), EnumAnimation.RUN.isLoop(), 0, 4, 0, 1, new int[]{200, 200, 200, 200}));
            ...
            // RUSH
            animatorController.addAnimation(EnumAnimation.RUSH, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuRush.png", 247, 247), EnumAnimation.RUSH.isLoop(), 0, 2, 0, 1, new int[]{200, 200}));
            ...
            // RECEIPT
            animatorController.addAnimation(EnumAnimation.RECEIPT, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuReceipt.png", 247, 247), EnumAnimation.RECEIPT.isLoop(), 0, 1, 0, 1, new int[]{130}));
            ...
            animatorController.addAnimation(EnumAnimation.RECEIPT, 1, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuReceipt.png", 247, 247), EnumAnimation.RECEIPT.isLoop(), 0, 3, 0, 1, new int[]{100, 100, 100}));
            ...
            // JUMP
            animatorController.addAnimation(EnumAnimation.JUMP, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuJump1.png", 247, 247), EnumAnimation.JUMP.isLoop(), 0, 3, 0, 1, new int[]{150, 150, 300}));
            ...
            animatorController.addAnimation(EnumAnimation.JUMP, 1, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuJump2.png", 247, 247), EnumAnimation.JUMP.isLoop(), 0, 3, 0, 1, new int[]{100, 100, 300}));
            ...
            // DEFENSE
            animatorController.addAnimation(EnumAnimation.DEFENSE, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuDef.png", 247, 247), EnumAnimation.DEFENSE.isLoop(), 0, 4, 0, 1, new int[]{200, 300, 300, 300}));
            ...
            // BLOCK
            animatorController.addAnimation(EnumAnimation.BLOCK, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuBlock.png", 247, 247), EnumAnimation.BLOCK.isLoop(), 0, 1, 0, 1, new int[]{200}));
            ...
            // HAND ATTACK
            animatorController.addAnimation(EnumAnimation.HAND_ATTACK, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuHandAttack1.png", 247, 247), EnumAnimation.HAND_ATTACK.isLoop(), 0, 4, 0, 1, new int[]{150, 150, 100, 150}));
            ...
            animatorController.addAnimation(EnumAnimation.HAND_ATTACK, 1, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuHandAttack2.png", 247, 247), EnumAnimation.HAND_ATTACK.isLoop(), 0, 2, 0, 1, new int[]{100, 100}));
            ...
            animatorController.addAnimation(EnumAnimation.HAND_ATTACK, 2, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuHandAttack3.png", 247, 247), EnumAnimation.HAND_ATTACK.isLoop(), 0, 2, 0, 1, new int[]{100, 200}));
            ...
            // HAND FLY PROPELS
//            animatorController.addAnimation(EnumAnimation.HAND_FLY_PROPELS, 0, AnimationFactory.createAnimation(new SpriteSheet(ConfigPath.gameIMG + name + state + "/gokuHandFlyPropels.png", 65, 70), EnumAnimation.HAND_FLY_PROPELS.isLoop(), 0, 5, 0, 1, new int[]{150, 150, 150, 150, 150}));
